(function() {
    ...
    const btsDashboard = {
        init: async function(map) {
            console.log("Inisialisasi dashboard BTS...");
            mapInstance = map;
        ...
        destroy: function() {
            console.log("Membersihkan dashboard BTS...");
   ...
   function onEachFeature(feature, layer) {
    ...
    function attachEventListeners() {
        ...
        createCheckboxFilter(
            'jaringan-dropdown-options',
            'jaringan-dropdown-button',
            'jaringan-selected-text',
            jaringanFilterTypes,
            selectedJaringanFilters,
            'Jaringan'
        );
        ...
        window.addEventListener('click', (e) => {
            ...
            if (!e.target.closest('#jaringan-dropdown')) {
                document.getElementById('jaringan-dropdown-options').classList.add('hidden');
            }
            if (!e.target.closest('#layanan-dropdown')) {
                document.getElementById('layanan-dropdown-options').classList.add('hidden');
            }
        });
    }
